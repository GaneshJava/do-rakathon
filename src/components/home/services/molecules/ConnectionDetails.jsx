...
const ConnectionDetails = () => {
    ...
    const { configure: state,name, service: { selectedService }, warning } = stateData;
    ...
    useEffect(() => {
        ...
        let defaultVal = document.getElementById('connectionName').value;
        dispatch(updateConfigure({ key: 'connectionName', value: connectionName || defaultVal }))
    }, [])
          ...
          <div>
            ...
            {warning['nameWarning'] && <p className="text-[#e26b6b] text-sm"> Service name is required field </p>}
                        ...
                        <Input
                            ...
                            customClass={`bg-[#2d3032] focus:outline-none focus:border-[#B9B6B6] border border-[#808080] h-[2.4rem] px-2 w-full rounded mt-2 placeholder:text-[#808080] placeholder:text-sm border ${warning[`${field.name}Warning`] ? 'border-[#e26b6b]' : ''}`} />
                        {field.type === 'password' &&
                            <span
                                className="absolute"
                ...
                <div className="flex">
                    <div className="basis-[50%] ">
                        <Input
                            ...
                            handleChange={handleChange}
                            customClass={`bg-[#2d3032] border-r-0 focus:outline-none focus:border-[#B9B6B6] border border-[#808080] h-[2.4rem] px-2 w-full rounded-r-none mt-2 placeholder:text-[#808080] placeholder:text-sm border ${warning[`hostWarning`] ? 'border-[#e26b6b]' : ''}`}
                        />
                    ...
                    <div className="basis-[50%]">
                        <div className="basis-[50%]">
                            ...
                            <Input
                                ...
                                handleChange={handleChange}
                                customClass={`bg-[#2d3032] focus:outline-none focus:border-[#B9B6B6] border border-[#808080] h-[2.4rem] px-2 w-full rounded-l-none mt-2 placeholder:text-[#808080] placeholder:text-sm border ${warning[`portWarning`] ? 'border-[#e26b6b]' : ''}`}
                            />
